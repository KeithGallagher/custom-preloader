...
<section style="width: auto;max-width: 41.563em;margin: .5em auto;padding: .5em 0;" class="code">
<p style="color: white;text-align: center;">This is your CSS Code.</p>
	<div class="box">
		...
		<div style="margin-left: -80px;width: 162px;height: 55px;top: 480px;font-size: larger;" class="tool-tip slideIn top">Copy CSS Code And Add To "Set ColorFul Background"</div>	</div>
</section>
